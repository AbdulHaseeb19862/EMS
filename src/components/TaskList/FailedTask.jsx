...
function FailedTask({ data }) {
  return (
    <div className="h-10/12 w-80 shrink-0  bg-green-400 rounded-2xl  p-3 pb-10 flex flex-col gap-6">
      ...
      <div className="w-full">
        <button className="bg-red-500 w-full py-1 px-2 rounded-md text-white">
          Failed
        </button>
      </div>
    </div>
